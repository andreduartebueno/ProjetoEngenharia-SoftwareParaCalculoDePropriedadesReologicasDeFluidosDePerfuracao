...
/**
@brief Classe que calcula a perda de carga do fluido de perfuração no poço para fluidos de Potência
...
public:
    ...
    /// Perda de Carga para Fluidos de Potência, com fluxo turbulento, no espaço anular e unidades no Sistema Internacional
    double perda_carga_Potencia_ft_ea_SI;
    /// Perda de Carga para Fluidos de Potência, com fluxo turbulento, no espaço anular e unidades de Campo
...
public:
    /// Construtor
    CPerdaCargaPotencia(CIndice* _pindice, CPoco* _ppoco) : pindice(_pindice), ppoco(_ppoco){};
    /// Destrutor
    ~CPerdaCargaPotencia() {};
    ...
    double Perda_carga_Potencia_ft_it_UC();
    /// Metodo para o calculo da Perda de Carga para Fluidos de Potência, com fluxo turbulento, no espaço anular e unidades no Sistema Internacional
    double Perda_carga_Potencia_ft_ea_SI();
    /// Metodo para o calculo da Perda de Carga para Fluidos de Potência, com fluxo turbulento, no espaço anular e unidades de Campo
    double Perda_carga_Potencia_ft_ea_UC();
